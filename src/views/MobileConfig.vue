            ...
            <div v-else class="space-y-4">
                <div v-for="(item, key) in config" :key="key"
                    ...
                    <div class="flex w-full text-md font-bold">
                        ...
                        <div class="text-right text-[#9c9c9f] font-medium ml-2">
                            {{ key }}
                        </div>
                    </div>
                    ...
                    <div class="flex w-full text-md font-bold">
                        ...
                        <template v-if="editingKey === key">
                            <input v-model="editedValue"
                                class="bg-transparent text-sm rounded-md px-2 py-[2px] border border-gray-600 w-full ml-2"
                                placeholder="Value" />
                        </template>
                        <div v-else class="text-right text-[#9c9c9f] font-medium ml-2">
                            {{ item.value }}
                        </div>
                    </div>
